...
Fascinating fact I can't prove yet #443: $Z_p$ is compact
----
It turns out that $Z_p$ can be given a topology. Since $\Bbb Z_p \subset \prod \Bbb Z/p^k\Bbb Z$, you can give the $\Bbb Z/p^k\Bbb Z$s the discrete topology, and give the product the product topology, and finally give $\Bbb Z_p$ the subspace topology. 
