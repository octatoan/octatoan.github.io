...
Like every metric, the p-adic metric confers a topology on its underlying set -- in this case, $\Bbb Z$. The completion of $\Bbb Z$ with respect to this metric is -- you guessed it -- $\Bbb Z_p$. What's more interesting, however, is this: $\Bbb Z_p$ is the [*completion*](https://en.wikipedia.org/wiki/Completion_%28algebra%29) of $\Bbb Z$ with respect to the p-adic metric.
